...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        statusDD.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Active", "Rented", "Cancelled", "Suspended" }));
        ...
        statusDD1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Active", "Rented", "Cancelled", "Suspended" }));
        ...
        statusS.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Active", "Rented", "Cancelled", "Suspended" }));
        ...
        editListingsPLayout.setHorizontalGroup(
                editListingsPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(editListingsPLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(editFeeI, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(36, 36, 36)
                                .addComponent(changeFeeB, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(feeMessage, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
                                .addGap(88, 88, 88))
                        .addGroup(editListingsPLayout.createSequentialGroup()
                                .addGap(262, 262, 262)
                ...
                editListingsPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, editListingsPLayout.createSequentialGroup()
                                ...
                                .addGroup(editListingsPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(editListingsPLayout.createSequentialGroup()
                                                .addGap(41, 41, 41)
                                                .addComponent(statusChangeMessage, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(58, 58, 58)
                                ...
                                .addGroup(editListingsPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(editListingsPLayout.createSequentialGroup()
                                                .addGap(17, 17, 17)
                                                .addComponent(feeMessage, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {
        if(access.equals("Manager")){
            ...
            populateTable(jTable2, propertyListings.getPropertyListing());
            editPeriodI.setVisible(true);
            changeFeeB.setVisible(true);
        }
        if(access.equals("Landlord")){
            editFeeI.setVisible(false);
            populateTable(jTable2, propertyListings.propertyListingLandlord(username));
            editPeriodI.setVisible(false);
            changeFeeB.setVisible(false);
        }
        if(access.equals("Manager") || access.equals("Landlord")){
    ...
    private void changeSMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if(access.equals("Landlord") && listingS > -1) {
            propertyID = propertyListings.landlordProperties(username).get(listingS).getPropertyID();
            propertyListings.changeListing(status, propertyID);
            populateTable(jTable2, propertyListings.propertyListingLandlord(username));
        }else if (access.equals("Manager") && listingS > -1) {

            propertyID = propertyListings.managerProperties().get(listingS).getPropertyID();
            propertyListings.changeListing(status, propertyID);
            populateTable(jTable2, propertyListings.getPropertyListing());
        }
    ...
    private void addListingQuoteBMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        String fee = "$" + feeHandler.getFee(period);
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {
        if(access.equals("Renter")){
            ...
            jTable4.getColumn("Contact").setCellRenderer(new ButtonRenderer());
